...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_localsitetesting_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_localsitetesting_dd.inc';
}
// </DDSETTINGS>
$settings['install_profile'] = 'openedu';

$config_directories['sync'] = '/Users/gms278/Sites/devdesktop/MY_PROJECT/docroot/sites/default/files/config_acqTmp-2018-06-14T13.24.57-2937/sync';